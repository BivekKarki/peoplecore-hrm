    ...
    const stream = new ReadableStream({
        async start(controller) {
            ...
            `),
                        ...
                        // 2. Recent check-ins (last 5 minutes — for the pulse animations)
                        query<{
            ...
            `),
                        ...
                        // 3. ALL currently-active employees (clocked in today, no checkout yet)
                        query<{
                            employee_id: string;
              ...
              SELECT
                ...
                e.avatar_color,
                ws.check_in,
                COALESCE(ws.check_in_method, 'kiosk') AS method,
